@extends('v1.site.center.layout_full')
        ...
        <div id="verify-form">
            <form class="layui-form" action="" lay-filter="component-form-group">
                ...
                <div class="module-box" style="margin-bottom:20px;">
                    <div class="cst-module-title">
                        <a href="javascript:;" class="title-block">
                            方案信息
                        </a>
                    </div>
                    <div class="module-content">
                        <div style="padding:20px 20px;">
                                <div class="cst-form-row">
                                    <div class="cst-form-item">
                                        <div class="cst-form-label">
                                            ...
                                            <span class="label-text">上传封面</span>
                                            <span class="help-text">建议上传16:9比例图片，大小不超过2M</span>
                                        </div>
                                        <div class="cst-form-input">
                                            <div class="cst-upload-block" id="b-upload-cover">
                                ...
                                <div class="cst-form-row">
                                    <div class="cst-form-item pull-left" style="width:520px;margin-right:20px;">
                                        <div class="cst-form-label">
                                            @if($config['title_required'])<span class="required">*</span> @endif
                                            <span class="label-text">标题</span>
                                            <span class="help-text">6-20个字</span>
                                        </div>
                                        <div class="cst-form-input">
                                ...
                                <div class="cst-form-row">
                                    ...
                                    <div class="cst-form-item " >
                                        <div class="cst-form-label">
                                            <span class="required">*</span>
                                            <span class="label-text">设计风格</span>
                                        </div>
                                        <div class="cst-form-input">
                                ...
                                <div class="cst-form-row">
                                    <div class="cst-form-item pull-left" style="width:520px;margin-right:20px;">
                                        <div class="cst-form-label">
                                            <span class="required">*</span>
                                            <span class="label-text">户型</span>
                                        </div>
                                        <div class="cst-form-input">
                                            <select name="house_type_id" lay-verify="required">
                                                @foreach($vdata['house_types'] as $item)
                                                    <option value="{{$item->id}}" @if(isset($album) && $album->house_type_ids && in_array($item->id,$album->house_type_ids)) selected @endif>{{$item->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>

                                    <div class="cst-form-item pull-left" style="width:520px;">
                                        <div class="cst-form-label">
                                            @if($config['total_area_required'])<span class="required">*</span> @endif
                                            <span class="label-text">面积</span>
                                        </div>
                                        <div class="cst-form-input">
                                            <?php
                                            ...
                                            ?>
                                            <input type="text" name="count_area" placeholder="平方米" value="{{$album->count_area or ''}}"  lay-verify="{{$count_area_verify}}" maxlength="20" autocomplete="off" placeholder="" class="layui-input">
                                        </div>
                                    </div>
                                    <div style="clear:both"></div>
                                ...
                                <div class="cst-form-row">
                                    ...
                                    <div class="cst-form-item pull-left" style="width:250px;">
                                        <div class="cst-form-label">
                                            @if($config['street_required'])<span class="required">*</span> @endif
                                            <span class="label-text">街道</span>
                                        </div>
                                        <div class="cst-form-input">
                                ...
                                <div class="cst-form-row">
                                    <div class="cst-form-item pull-left" style="width:250px;margin-right:20px;">
                                        <div class="cst-form-label">
                                            @if($config['residential_quarter_required'])<span class="required">*</span> @endif
                                    ...
                                    <div class="cst-form-item pull-left" style="width:250px;margin-right:20px;">
                                        <div class="cst-form-label">
                                            @if($config['building_required'])<span class="required">*</span> @endif
                                            <span class="label-text">所在楼栋</span>
                                        </div>
                                        <div class="cst-form-input">
                                    ...
                                    <div class="cst-form-item pull-left" style="width:250px;">
                                        <div class="cst-form-label">
                                            @if($config['layout_number_required'])<span class="required">*</span> @endif
                                            <span class="label-text">所在户型号</span>
                                        </div>
                                        <div class="cst-form-input">
                                ...
                                <div class="cst-form-row">
                                    <div class="cst-form-item" >
                                        <div class="cst-form-label">
                                            @if($config['description_design_required'])<span class="required">*</span> @endif
                                            <span class="label-text">设计说明</span>
                                        </div>
                                        <div class="cst-form-input">
                                            <textarea name="description_design" @if($config['description_design_required'])lay-verify="required"@endif maxlength="{{$config['description_design_char_limit']}}" style="width: 100%;height: 150px;" autocomplete="off" class="layui-textarea">{{$album->description_design or ''}}</textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="module-content">
                        <div style="padding:20px 20px;">
                            <div class="cst-form-row">
                                <div class="cst-form-item">
                                    <div class="cst-form-label">
                                        @if($config['photo_layout_min_limit']>0)<span class="required">*</span> @endif
                                        <span class="label-text">上传户型图</span>
                                    ...
                                    <div class="cst-form-input">
                                        <div class="info-list">
                                            @if(isset($album) && $album->photo_layout != NULL)
                                                ...
                                                @endforeach
                                            @endif
                                                @include('v1.site.center.album.components.photo-layout-tpl',['data'=>null,'is_add_btn'=>true])
                                ...
                                <div class="cst-form-item">
                                    <div class="cst-form-label">
                                        @if($config['description_layout_required'])<span class="required">*</span> @endif
                                        <span class="label-text">户型说明</span>
                                    </div>
                                    <div class="cst-form-input">
                                        <textarea name="description_layout" @if($config['description_layout_required'])lay-verify="required"@endif maxlength="{{$config['description_layout_char_limit']}}" style="width: 100%; height: 130px;" autocomplete="off" class="layui-textarea">{{$album->description_layout or ''}}</textarea>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="module-box" style="margin-bottom:20px;">
                    ...
                    <div class="module-content">
                        ...
                        <div class="info-list" style="background-color:#EFEFEF">
                            ...
                            @if(isset($album))
                                ...
                                @endforeach
                            @else
                                @include('v1.site.center.album.components.album-section-tpl',['section'=>null,'config'=>$config,'styles'=>$vdata['styles'],'space_types'=>$vdata['space_types']])

                            @endif

                                <div id="cst-add-section-btn-box">
                                    <div id="cst-add-section-btn"  onclick="add_section_block(this)" data-tpl="album-section-tpl" data-add-type="album_section"> + 添加空间</div>
                ...
                {{--产品清单--}}
                @if(\Illuminate\Support\Facades\Auth::user()->organization_type != \App\Models\Designer::ORGANIZATION_TYPE_NONE)
                <div class="module-box" style="margin-bottom:60px;">
                    <div class="cst-module-title">

                        <a href="javascript:;" class="title-block">
                            @if(isset($config['product_min_limit']) && $config['product_min_limit']>0)
                                <span style="color:#fb4040;margin-right:8px;font-size:16px;">*</span>
                            @endif
                            产品清单
                        </a>
                    </div>
                    <div class="module-content" style="overflow:hidden;">
                        ...
                        <div id="choose-product-btn" type="button" onclick="openProductChoose()">选择产品</div>
                ...
                <div class="submit-box">
                    ...
                    <button type="button" id="submit-btn" style="margin-right:30px;" class=" save-btn submit-btn" lay-submit lay-filter="submitFormBtn">发布</button>
                    <button type="button" class=" save-btn temp-save-btn" lay-submit lay-filter="submitFormTempBtn">暂存</button>

                    {{csrf_field()}}
                    <input type="hidden" name="web_id_code" value="{{$album->web_id_code or ''}}"/>
                    <div style="clear:both;"></div>
                </div>
...
@section('script')
    <script>
        ...
        var uploadAvatar = upload.render({
            elem: '#b-upload-cover'
            ,url: '{{url($url_prefix.'center/album/api/upload_img')}}'
        ...
        $(function () {
            ...
            /*layui.use(['jquery','xmSelect'], function () {
                xmselect_style = xmSelect.render({
                    el: '#xmselect-style',
                    name: 'n-style-id',
                    layVerify: 'required',
                    theme: {
                    ...
                    data: [
                        @foreach($vdata['styles'] as $item)
                        {name: '{{$item->name}}', value: '{{$item->id}}' @if(isset($album) && in_array($item->id,$album->style_ids)) ,selected:true @endif},
                        @endforeach
                    ]
                })
        ...
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/center/album/api')}}/{{$album->web_id_code}}";
        submitMethod = "PUT";
        @endif
    ...
    <script>
        function choose_product(select_data){
            //已选产品
        ...
        //打开产品选择框
        function openProductChoose(){
            let page = '{{url('/center/album/choose_product')}}';
            layer.open({
                type: 2,
                title:'选择产品',
                area:['1100px', '650px'],
        ...
        //移除方案空间
        function remove_section_block(obj){
            var info_block = $(obj).parents('.section-info-row')[0];
            info_block.remove();
        }
        ...
        //初始化方案空间中的空间风格多选下拉框
        function init_section_xmselect(){
            layui.use(['jquery','xmSelect'], function () {
                xmselect_section_style = xmSelect.render({
                    el: '.xmselect-section-style',
                    name: 'section_style_id[]',
                    layVerify: 'required',
                    theme: {
                        color: '#1582FF',
                    },
        ...
        function init_upload_block(){
            layui.each($(".cst-upload-box .i-upload-block"),function(index, elem){
                console.log(elem);
                var is_edit = $(elem).attr('data-is-edit');
                    ...
                    upload.render({
                        ...
                        ,done: function(res){
                            ...
                            if(is_edit==1){
                                ...
                                //如果当前上传块是新增按钮，则往当前添加按钮前插入一个编辑快
                                var info_list = $(elem).parents('.info-list')[0];
                                var tpl_name = $(elem).attr('data-tpl');
                                var block_tpl = $('#'+tpl_name).html();
                                var $block_tpl = $(block_tpl)
                                $block_tpl.find('.'+name_class).val(res.data.access_path);
                                $block_tpl.find('.upload-img-preview').css('background-image','url('+res.data.access_path+')');
                                $block_tpl.find('.i-upload-block').attr('data-is-edit','1')
                                $(elem).parents('.cst-upload-box').before($block_tpl);
                                form.render();
                                init_upload_block();
                            }
            ...
            layui.each($(".cst-upload-box .video-upload-drag"),function(index, elem){
                var is_init = $(elem).attr('data-is-init');
                var name_class = $(elem).attr('data-name-class');
                var upload_url = $(elem).attr('data-upload-url');
    ...
    <script>
        $(document).ready(function(){
            ...
            //删除上传块
            $(document).on('click','.cst-upload-box .delete-block',function(e){
                var info_block = $(this).parents('.cst-upload-box')[0];
                info_block.remove();
            })
        });
    </script>
