        ...
        <form class="layui-form" action="" lay-filter="component-form-group">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="oldphone" id="oldphone" value=""  lay-verify="required" autocomplete="off" placeholder="请输入原手机号" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="newphone" id="newphone" value=""  lay-verify="required" autocomplete="off" placeholder="请输入新手机号" class="layui-input">
                </div>
            </div>
...
@section('script')
    ...
    <script>
        ...
        function get_mobile_captcha(elem,action) {
            ...
            var time = 60;
            var api_url = '{{ url('center/getResetPhoneSmsCode') }}' + '?login_mobile=' +mobile;
        ...
        form.on('submit(submitFormBtn)', function(form_info){
            ...
            ajax_post('{{url($url_prefix.'center/reset_phone/reset')}}',
                form_field,
                function(result){
                    // console.log(result);
                    if(result.status){
