...
@section('content')
    <div class="layui-card layadmin-header">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <div class="right" style="margin-right:15px;">
                @can('account_manage.account_index.brand_admin_index')
                <button onclick="location.href='{{url('/admin/brand/sub_admin/account')}}'" class="layui-btn layui-btn-sm layui-btn-custom-blue" >
                    <i class="layui-icon layui-icon-sm layui-icon-link" style="font-size:12px!important;"></i>管理员列表
                </button>
                @endcan
            </div>
    ...
    <div class="layui-fluid">
                    ...
                    <div class="layui-inline filter-block">
                        ...
                        <div class="layui-input-inline" style="padding-right: 14px">
                            <select name="is_super_admin" lay-verify="">
                                ...
                                @foreach(\App\Models\RoleBrand::isSuperAdminGroup() as $key=>$item)
        ...
        @can('account_manage.role_create')
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('account_manage.role_delete')
...
@section('script')
    ...
    <script>
        ...
        form.render();
        let base_api = '{{url('/admin/brand/role/api')}}';
        let table_api = '{{url('/admin/brand/role/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'display_name', title: '名称', sort: true}
                ...
                ,{field: 'created_by_administrator', title: '创建者'}
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/brand/role/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/brand/role')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
