...
@section('script')
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/brand/role/api')}}";
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/admin/brand/role/api')}}/{{$data->id}}";
            submitMethod = "PUT";
        @endif
    ...
    @include('v1.admin.components.role_edit.select_privileges_script',
     ...
     'api_url'=>url($url_prefix.'admin/brand/role/api/get_role_privilege_options')])
    @else
        @include('v1.admin.components.role_edit.select_privileges_script',
