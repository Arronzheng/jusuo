        ...
        <form>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="number" id="i-integral" onkeyup="value=value.replace(/^(0+)|[^\d]+/g,'');" name="integral"  placeholder="请输入正整数" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">发放原因</label>
                <div class="layui-input-inline">
                    <input type="text" name="remark" value="" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
...
@section('script')
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/brand/sub_admin/seller/api/account')}}/{{$admin->id}}/integral_distribute";
