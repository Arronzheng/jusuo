...
@section('content')
    <div class="layui-card layadmin-header">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            {{--<a><cite>设计师基础资料</cite></a><span lay-separator="">/</span>--}}
            <a><cite>设计师基础资料</cite></a>
        </div>
    </div>
...
@section('body')
    <script type="text/html" id="tableToolbarTpl">
        @can('account_manage.info_verify.designer_basic_info.brand_designer_detail')
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/info_verify/designer_basic/api/brand')}}';
        let table_api = '{{url('/admin/brand/info_verify/designer_basic/api/brand')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/brand/info_verify/designer_basic/brand')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
