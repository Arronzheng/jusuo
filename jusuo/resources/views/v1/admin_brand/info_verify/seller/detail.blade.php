            ...
            <div class="layui-card-body" style="padding: 15px;">
                    ...
                    @if(isset($verify_content['area_serving_id']))
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-form-mid layui-word-aux">
                                    {{$verify_content['province'] or ''}}{{$verify_content['city'] or ''}}{{$verify_content['district'] or ''}}
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 300px">
                        @if($verify_content['is_approved'] == \App\Models\LogDealerCertification::IS_APROVE_VERIFYING)
                            @can('account_manage.info_verify.seller_info_pass')
                            <button href="javascript:;" onclick="ajax_pass_seller('{{url('admin/brand/api/seller_verify/'.$verify_content['id'].'/approval')}}')" class="layui-btn-success layui-btn" lay-event="edit">
                                <i class="layui-icon layui-icon-ok"></i>通过
                            </button>
                            @endcan
                            @can('account_manage.info_verify.seller_info_reject')
                            <button href="javascript:;" onclick="ajax_reject_seller('{{url('admin/brand/api/seller_verify/'.$verify_content['id'].'/reject')}}')" class="layui-btn-danger layui-btn" lay-event="del">
