...
@section('body')
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('account_manage.info_verify.seller_info_detail')
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/api/seller_verify')}}';
        let table_api = '{{url('/admin/brand/api/seller_verify')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'login_account', width:160, fixed: 'left',  title: '登录账号'}
                ,{field: 'login_username',width:120, title: '登录用户名'}
                ,{field: 'level',width:70, title: '级别'}
                ,{field: 'dealer_name',width:150, title: '名称',}
                ,{field: 'legal_person_name',width:120, title: '法人代表',}
                ,{field: 'area_serving',width:160, title: '服务城市',}
                ,{field: 'contact_name',width:120, title: '联系人'}
                ,{field: 'login_mobile',width:120, title: '联系电话'}
                ,{field: 'designer_count',width:70, title: '设计师账号(已授/可授)'}
                ,{field: 'created_at',width:120, title: '创建时间'}
                ,{field: 'expired_at',width:120, title: '账号有效期限'}
                ,{field: 'account_status_text',width:120, title: '账户状态'}
                ,{field: 'dealer_status_text',width:120, title: '认证状态'}
                ,{field: 'approve_text',fixed: 'right',width:120, title: '审核结果'}
                ,{field: 'operation', fixed: 'right',title: '操作' ,width:80 ,templet:'#tableToolbarTpl'}
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/brand/seller_verify')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
