                        ...
                        <div class="layui-form-item" style="margin-top:20px;">
                            ...
                            <div class="layui-input-inline" style="width: 300px">
                                @if($verify_content['is_approved'] == \App\Models\LogDesignerCertification::IS_APROVE_VERIFYING)
                                    @can('account_manage.info_verify.designer_realname_info.brand_designer_pass')
                                    <a href="javascript:;" onclick="ajax_pass_member('{{url('admin/brand/info_verify/designer_certification/api/brand/'.$verify_content['id'].'/approval')}}')" class="layui-btn-success layui-btn" lay-event="edit">
                                        <i class="layui-icon layui-icon-ok"></i>通过
                                    </a>
                                    @endcan
                                    @can('account_manage.info_verify.designer_realname_info.brand_designer_reject')
                                    <a href="javascript:;" onclick="ajax_reject_member('{{url('admin/brand/info_verify/designer_certification/api/brand/'.$verify_content['id'].'/reject')}}')" class="layui-btn-danger layui-btn" lay-event="del">
