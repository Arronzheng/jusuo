...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/info_verify/designer_certification/api/seller')}}';
        let table_api = '{{url('/admin/brand/info_verify/designer_certification/api/seller')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/brand/info_verify/designer_certification/seller')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
