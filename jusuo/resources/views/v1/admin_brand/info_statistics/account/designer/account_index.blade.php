        ...
        <div id="filterContainer" class="layui-form c-table-filter-container fold" lay-filter="app-content-list">
            ...
            <form action="" method="get">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline filter-block">
                        <label class="layui-form-label">所属销售商</label>
                        <div class="layui-input-inline">
                            <input type="text" autocomplete="off" id="seller-select" class="organization-select layui-input"  value="" readonly placeholder="点击搜索并选择" >
                            <input type="hidden" name="orgid" value="" id="h-belong-organization">
                        </div>
                    </div>
                    <div class="layui-form-item">
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/brand/info_statistics/account/designer/api/get_sellers') !!}',
                        cols: [[
                            { type: 'radio' },
        ...
        function get_table_cols(){
            return [[ //表头
                ...
                ,{field: 'count_upload_album',width:120,sort:true, title: column_prefix+'方案数'}
                ,{field: 'count_top_album',width:150,sort:true, title: column_prefix+'方案置顶次数'}
                ,{field: 'count_fav_album',width:140,sort:true, title: column_prefix+'收藏方案数'}
                ,{field: 'count_download_album',width:140,sort:true, title: column_prefix+'下载方案数'}
                ,{field: 'count_copy_album',width:140,sort:true, title: column_prefix+'复制方案数'}
                ,{field: 'count_praise_album',width:140,sort:true, title: column_prefix+'点赞方案数'}
                ,{field: 'count_fav_designer',width:160,sort:true, title: column_prefix+'关注设计师数'}
                ...
                ,{field: 'organization',width:160,  title: '所属组织'}
        ...
        let base_api = '{{url('/admin/brand/info_statistics/account/designer/api')}}';
        let table_api = '{{url('/admin/brand/info_statistics/account/designer/api')}}';
    ...
    <script>
        ...
        function reloadTable(sortObj){
            ...
            var range_delta = $('select[name="range_delta"]').val();
            if(range_delta==1){
                column_prefix='昨天'
            }else if(range_delta==7){
                column_prefix='7天'
            }else if(range_delta==30){
                column_prefix='30天'
            }else{
                column_prefix = '';
            }
        ...
        function openDetail(id){
            let page = '{{url('/admin/brand/info_statistics/account/designer')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
