        ...
        <div id="filterContainer" class="layui-form c-table-filter-container fold" lay-filter="app-content-list">
            ...
            <form action="" method="get">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline filter-block">
                        <label class="layui-form-label">新增数统计范围</label>
                        <div class="layui-input-inline">
...
@section('body')
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('info_statistic.account.seller_detail')
        <a onclick="openDetail('@{{d.seller_id}}')" title="查看详情" href="javascript:;"  class="layui-btn-custom-blue layui-btn  layui-btn-xs">
            <i class="layui-icon layui-icon-list"></i>
        </a>
        @endcan

        @can('info_statistic.account.seller_set_top')
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/brand/info_statistics/account/seller/api/get_brands') !!}',
                        cols: [[
                            { type: 'radio' },
        ...
        let base_api = '{{url('/admin/brand/info_statistics/account/seller/api')}}';
        let table_api = '{{url('/admin/brand/info_statistics/account/seller/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'area_serving_text',width:150, title: '服务城市'}
                ...
                ,{field: 'count_product',width:140,sort: true, title: '上线产品数'}
                ,{field: 'count_designer',width:130,sort: true, title: '设计师数'}
                ,{field: 'count_album_increase',width:120,sort: true, title: '新增方案数'}
                ,{field: 'count_product_increase',width:170,sort: true, title: '新增授权产品数'}
                ,{field: 'count_designer_increase',width:200,sort: true, title: '新开通直属设计师数'}
                ,{field: 'start_at',width:160,sort: true,  title: '开通时间'}
                ,{field: 'seller_status_text',width:100, title: '账号状态'}
    ...
    <script>
        ...
        function reloadTable(sortObj){
            table.reload('tableInstance',{
                ...
                ,where: {
                    ...
                    ,range_delta: $('select[name="range_delta"]').val()
        ...
        function openDetail(id){
            let page = '{{url('/admin/brand/info_statistics/account/seller')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
