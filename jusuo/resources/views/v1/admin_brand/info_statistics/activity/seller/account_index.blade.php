...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/info_statistics/activity/seller/api')}}';
        let table_api = '{{url('/admin/brand/info_statistics/activity/seller/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'company_name', title: '销售商名称'}
                ,{field: 'area_belong_text', title: '所在城市'}
                ,{field: 'count_album_increase_day_7',width:120,sort: true, title: '新增方案数'}
                ,{field: 'count_product_increase_day_7',width:170,sort: true, title: '新增授权产品数'}
                ,{field: 'count_designer_increase_day_7',width:200,sort: true, title: '新开通直属设计师数'}
            ]]
        });
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/brand/info_statistics/activity/seller')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
