...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/info_statistics/activity/designer/api')}}';
        let table_api = '{{url('/admin/brand/info_statistics/activity/designer/api')}}?type={{request()->input("type")}}';
        //转换静态表格
