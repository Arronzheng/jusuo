...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/info_statistics/album/api')}}';
        let table_api = '{{url('/admin/brand/info_statistics/album/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'belong_city',width:140, title: '设计师所在城市'}
                ...
                ,{field: 'album_section_space_type',width:120,title: '空间类别'}
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/brand/info_statistics/album')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
