...
@section('content')
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('account_manage.account_index.designer.seller_designer_detail')
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/seller_designer/api/account')}}';
        let table_api = '{{url('/admin/brand/seller_designer/api/account')}}?type={{request()->input("type")}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'operation',fixed: 'right', title: '操作' , width:120 ,templet:'#tableToolbarTpl'}
    ...
    <script>
        ...
        function modifyLevel(id){
            let page = '{{url('/admin/brand/seller_designer/account')}}/'+id+"/modify_level";
            layer.open({
                type: 2,
                title:'修改等级',
                area:['700px', '300px'],
        ...
        function openDetail(id){
            let page = '{{url('/admin/brand/seller_designer/account')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
