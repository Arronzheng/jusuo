...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/brand/album/index/hd/brand_designer/api/get_brands') !!}',
                        cols: [[
                            { type: 'radio' },
        ...
        let base_api = '{{url('/admin/brand/album/index/hd/brand_designer/api')}}';
        let table_api = '{{url('/admin/brand/album/index/hd/brand_designer/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'status_brand_text',width:120 ,fixed:'right', title: '品牌展示状态'}
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/brand/album/index/hd/brand_designer')}}/'+id;
            layer.open({
                type: 2,
                title:'方案详情',
                area:['900px', '600px'],
