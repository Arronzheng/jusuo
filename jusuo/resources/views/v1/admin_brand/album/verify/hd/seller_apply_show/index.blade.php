...
@section('content')
    <div class="layui-card layadmin-header">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            {{--<a><cite>方案审核</cite></a><span lay-separator="">/</span>
            <a><cite>高清图</cite></a><span lay-separator="">/</span>--}}
            <a><cite>销售商方案展示申请</cite></a>
            <div class="right" style="margin-right:15px;">
                @can('album_manage.album_index')
                <button onclick="location.href='{{url('/admin/brand/album/index/common')}}'" class="layui-btn layui-btn-sm layui-btn-custom-blue" >
                    <i class="layui-icon layui-icon-sm layui-icon-link" style="font-size:12px!important;"></i>方案列表
                </button>
                @endcan
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('album_manage.verify.hd_photo.seller_album_apply_brand')
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/brand/album/verify/hd/seller_apply_show/api/get_brands') !!}',
                        cols: [[
                            { type: 'radio' },
        ...
        let base_api = '{{url('/admin/brand/album/verify/hd/seller_apply_show/api')}}';
        let table_api = '{{url('/admin/brand/album/verify/hd/seller_apply_show/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/brand/album/verify/hd/seller_apply_show')}}/'+id;
            layer.open({
                type: 2,
                title:'方案详情',
                area:['900px', '600px'],
        ...
        function editData(type,id){
            let page = '{{url('/admin/brand/album/verify/hd/seller_apply_show/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/brand/album/verify/hd/seller_apply_show')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
