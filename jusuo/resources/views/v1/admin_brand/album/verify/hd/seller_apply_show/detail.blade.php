                ...
                {{--<div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 300px">
                        @can('album_manage.verify.hd_photo.seller_album_apply_brand_pass')
                            <a href="javascript:;" onclick="ajax_pass_album('{{url('admin/brand/album/verify/hd/seller_apply_show/api/'.$data->id.'/approval')}}')" class="layui-btn-success layui-btn" lay-event="edit">
                                <i class="layui-icon layui-icon-ok"></i>通过
                            </a>
                        @endcan
                        @can('album_manage.verify.hd_photo.seller_album_apply_brand_reject')
                            <a href="javascript:;" onclick="ajax_reject_album('{{url('admin/brand/album/verify/hd/seller_apply_show/api/'.$data->id.'/reject')}}')" class="layui-btn-danger layui-btn" lay-event="del">
