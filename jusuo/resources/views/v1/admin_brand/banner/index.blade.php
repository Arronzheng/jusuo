...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/banner/api')}}';
        let table_api = '{{url('/admin/brand/banner/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/brand/banner/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/brand/banner')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
