...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/product/verify/pass/api')}}';
        let table_api = '{{url('/admin/brand/product/verify/pass/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'type_text',title: '审核类型'}
                ,{field: 'name',title: '名称'}
                ,{field: 'created_at', title: '提交时间'}
                ,{field: 'created_by', title: '提交人'}
                ,{field: 'updated_at', title: '通过时间'}
