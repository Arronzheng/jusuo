    ...
    <form style="width:900px;">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" @if($cf['name.character_limit'])maxlength="{{$cf['name.character_limit']}}" @endif  value="{{$data->name or ''}}" placeholder="请输入产品名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">@if($cf['code.required'])<span class="required">*</span>@endif 产品编号</label>
            <div class="layui-input-inline">
                <input type="text" name="code" value="{{$data->code or ''}}" @if($cf['code.character_limit'])maxlength="{{$cf['code.character_limit']}}" @endif placeholder="请输入产品编号" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <textarea name="key_technology" @if($cf['key_technology.character_limit'])maxlength="{{$cf['key_technology.character_limit']}}" @endif style="width: 400px; height: 150px;" autocomplete="off" class="layui-textarea">{{$data->key_technology or ''}}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <textarea name="customer_value"  @if($cf['customer_value.character_limit'])maxlength="{{$cf['customer_value.character_limit']}}" @endif style="width: 400px; height: 150px;" autocomplete="off" class="layui-textarea">{{$data->customer_value or ''}}</textarea>
            </div>
        </div>
        {{--<div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="" >
                ...
                <div class="info-list">
                    @if(isset($data) && $data->photo_product != NULL && !is_array($data->photo_product))
