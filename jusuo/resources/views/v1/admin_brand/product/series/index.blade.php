...
@section('content')
    ...
    <div class="layui-fluid">
        ...
        @can('product_manage.series_create')
    ...
    <script type="text/html" id="tableToolbarTpl">
        @can('product_manage.series_edit')
        ...
        @can('product_manage.series_switch')
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/product/series/api')}}';
        let table_api = '{{url('/admin/brand/product/series/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'product_count', title: '产品总数'}
                ,{field: 'product_on_count', title: '产品上架数'}
                ,{field: 'product_off_count', title: '产品下架数'}
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/brand/product/series/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/brand/product/series')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
