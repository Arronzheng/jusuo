<div class="info-block" style="margin-bottom:15px;float:left;">
    <div class="layui-input-inline">
        ...
        <div class="layui-upload-drag image-upload-drag" data-is-init="0" data-name-class="n-photo-practicality" data-upload-url="{!! url('admin/brand/product/api/upload_product_image') !!}">
            <i class="layui-icon"></i>
            <p>仅支持JPG/PNG格式，每张图片大小限制2M以内</p>
            <input type="hidden" class="n-photo-practicality" lay-verify="photo_required" data-photo-type="实物图" value="{{$data or ''}}"/>
