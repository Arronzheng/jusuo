...
@section('content')
    <div class="layui-card layadmin-header">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <div class="right" style="margin-right:15px;">
                ...
                <button onclick="location.href='{{url('/admin/brand/product/authorize/log?log_type='.\App\Models\LogProductAuthorization::LOG_TYPE_SHOW)}}'" class="layui-btn layui-btn-sm layui-btn-custom-blue" >
    ...
    <div class="layui-fluid">
        ...
        <div class="op-container">
            <div class="left"></div>
            <div class="right">
                <a  class="layui-btn layui-btn-custom-blue" onclick="openAuthorizeObject('add')">授权/取消授权一级销售商</a>
                <a  class="layui-btn layui-btn-custom-blue" onclick="authorizeGlobal('show')">设置全局可见</a>
                <a  class="layui-btn layui-btn-custom-blue" onclick="authorizeGlobal('hide')">设置全局不可见</a>
            </div>
        </div>
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/product/authorize/show/api')}}';
        let table_api = '{{url('/admin/brand/product/authorize/show/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openAuthorizeObject(type,id){
            ...
            let page = '{{url('/admin/brand/product/authorize/show/object')}}';
            layer.open({
                type: 2,
                title:'授权/取消授权一级销售商',
                area:['900px', '600px'],
        ...
        function authorizeGlobal(operation) {
            //显示loading
            layer.load(1);
            //获取选中行
            var checkStatus = get_table_check_status();
            ...
            ajax_post('{{url('admin/brand/product/authorize/show/api/authorize_global')}}',{ids:checked_ids,op:operation}, function (res) {
                if (res.status == 1) {
                    layer.msg('操作成功！');
                    reloadTable()
                } else {
