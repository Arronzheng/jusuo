...
@section('content')
    <div class="layui-card layadmin-header">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <div class="right" style="margin-right:15px;">
                ...
                <button onclick="location.href='{{url('/admin/brand/product/authorize/log?log_type='.\App\Models\LogProductAuthorization::LOG_TYPE_STRUCTURE)}}'" class="layui-btn layui-btn-sm layui-btn-custom-blue" >
    ...
    <div class="layui-fluid">
        ...
        <div class="op-container">
            <div class="left"></div>
            <div class="right">
                <a  class="layui-btn layui-btn-custom-blue" onclick="openAuthorizeObject('add')">设置产品结构</a>
            </div>
        </div>
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/brand/product/authorize/structure/api')}}';
        let table_api = '{{url('/admin/brand/product/authorize/structure/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openAuthorizeObject(type,id){
            ...
            let page = '{{url('/admin/brand/product/authorize/structure/object')}}';
            layer.open({
                type: 2,
                title:'设置产品结构',
                area:['900px', '600px'],
