            ...
            <div class="layui-card-body" style="padding: 15px;">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 300px">
                        @can('album_manage.verify.hd_photo.brand_album_apply_platform_pass')
                            <a href="javascript:;" onclick="ajax_pass_album('{{url('admin/platform/album/verify/hd/brand_apply_show/api/'.$data->id.'/approval')}}')" class="layui-btn-success layui-btn" lay-event="edit">
                                <i class="layui-icon layui-icon-ok"></i>通过
                            </a>
                        @endcan
                        @can('album_manage.verify.hd_photo.brand_album_apply_platform_reject')
                            <a href="javascript:;" onclick="ajax_reject_album('{{url('admin/platform/album/verify/hd/brand_apply_show/api/'.$data->id.'/reject')}}')" class="layui-btn-danger layui-btn" lay-event="del">
...
@section('script')
    <script>
        ...
        function ajax_pass_album(url) {
            layer.confirm('你确定审核通过该方案在平台显示吗？', {icon: 3, title: '提示！'}, function () {
                //显示loading
                layer.load(1);
                //将提交按钮设置不可用
