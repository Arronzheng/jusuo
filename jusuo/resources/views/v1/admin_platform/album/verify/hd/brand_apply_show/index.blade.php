...
@section('content')
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('album_manage.verify.hd_photo.brand_album_apply_platform')
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/platform/album/verify/hd/brand_apply_show/api/get_brands') !!}',
                        cols: [[
                            { type: 'radio' },
        ...
        let base_api = '{{url('/admin/platform/album/verify/hd/brand_apply_show/api')}}';
        let table_api = '{{url('/admin/platform/album/verify/hd/brand_apply_show/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/platform/album/verify/hd/brand_apply_show')}}/'+id;
            layer.open({
                type: 2,
                title:'方案详情',
                area:['900px', '600px'],
        ...
        function editData(type,id){
            let page = '{{url('/admin/platform/album/verify/hd/brand_apply_show/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/platform/album/verify/hd/brand_apply_show')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
