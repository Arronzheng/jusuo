...
@section('content')
                ...
                <div class="layui-form-item">
                    ...
                    <div style="padding-top:13px;">
                        ...
                        <div class="layui-inline filter-block">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="owner" autocomplete="off" value="{{request()->input('rn')? : ''}}" placeholder="" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline filter-block">
    ...
    @can('product_manage.product_create')
        <div class="op-container">
            <div class="left"></div>
            <div class="right">
                <a  class="layui-btn layui-btn-custom-blue" href="{{url('/admin/platform/album/index/hd/brand/create')}}">新增</a>
            </div>
        </div>
        @endcan
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('album_manage.album_index.hd_photo.brand_album_detail')
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/platform/album/index/hd/brand/api/get_brands') !!}',
                        cols: [[
                            { type: 'radio' },
        ...
        let base_api = '{{url('/admin/platform/album/index/hd/brand/api')}}';
        let table_api = '{{url('/admin/platform/album/index/hd/brand/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/platform/album/index/hd/brand')}}/'+id;
            layer.open({
                type: 2,
                title:'方案详情',
                area:['900px', '600px'],
