...
@section('content')
    ...
    @can('product_manage.product_create')
        <div class="op-container">
            <div class="left"></div>
            <div class="right">
                <a  class="layui-btn layui-btn-custom-blue" href="{{url('/admin/platform/album/index/hd/free_designer/create')}}">新增</a>
            </div>
        </div>
        @endcan
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('album_manage.album_index.hd_photo.free_designer_album_detail')
        <a onclick="openDetail('@{{d.id}}')" title="查看详情" href="javascript:;"  class="layui-btn-custom-blue layui-btn  layui-btn-xs">
            <i class="layui-icon layui-icon-list"></i>
        </a>
        @endcan

        @can('album_manage.album_index.hd_photo.free_designer_album_switch')
        @{{#     if( d.visible_status=='100' ){       }}
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/platform/album/index/hd/free_designer/api/get_brands') !!}',
                        cols: [[
                            { type: 'radio' },
        ...
        let base_api = '{{url('/admin/platform/album/index/hd/free_designer/api')}}';
        let table_api = '{{url('/admin/platform/album/index/hd/free_designer/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/platform/album/index/hd/free_designer')}}/'+id;
            layer.open({
                type: 2,
                title:'方案详情',
                area:['900px', '600px'],
