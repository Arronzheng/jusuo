...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/integral/exchange_log/api')}}';
        let table_api = '{{url('/admin/platform/integral/exchange_log/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function export_table(){
            ...
            $('#filter-form').attr('action',"{{url('/admin/platform/integral/exchange_log/api')}}");
            $('#filter-form').submit();
        }

        //发货
        function send_exchange(id){
            let page = '{{url('/admin/platform/integral/exchange_log')}}/'+id+"/send";
