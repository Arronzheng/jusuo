                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline filter-block">
                        ...
                        <div class="layui-input-inline" style="padding-right: 14px">
                            <select name="log_type_operation" lay-verify="">
                                <option value="">全部</option>
                                @foreach(\App\Models\LogIntegralGoodAuthorization::logTypeOperationGroup() as $key=>$item)
                                    <option value="{{$key}}">{{$item}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="layui-inline filter-block">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="bn" autocomplete="off" value="{{request()->input('bn')? : ''}}" placeholder="" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline filter-block">
                        <label class="layui-form-label" >商品名称：</label>
                        <div class="layui-input-inline">
                            <input type="text" name="gn" autocomplete="off" value="{{request()->input('gn')? : ''}}" placeholder="" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline filter-block">
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/integral/authorize/log/api')}}';
        let table_api = '{{url('/admin/platform/integral/authorize/log/api')}}?log_type='+log_type;
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'goods', title: '相关商品'}
                ,{field: 'objects', title: '相关品牌'}
    ...
    <script>
        ...
        function export_table(){
            ...
            $('#filter-form').attr('action',"{{url('/admin/platform/integral/authorize/log/api')}}");
            $('#filter-form').submit();
        }
        ...
        function openAuthorizeObject(type,id){
            ...
            let page = '{{url('/admin/platform/integral/authorize/log/object')}}';
            layer.open({
                type: 2,
                title:'设置产品价格',
                area:['900px', '600px'],
