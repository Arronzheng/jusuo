    ...
    <div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 20px 30px 0 0;">
        <form>
            {{--<div class="layui-form-item">
                <label class="layui-form-label"><span class="required">*</span> 礼品图片</label>
...
--}}
                    ...
                    <div class="info-list">
                        @if(isset($data) && $data->param_data != NULL)
                            @foreach ($data->param_data as $item)
                                @include("v1.admin_platform.integral.components.goods-param-tpl",['data'=>$item])
                            @endforeach
                        @endif
                    </div>
                    <div style="clear:both"></div>
    ...
    <script type="text/html" id="goods-param-tpl">
        @include("v1.admin_platform.integral.components.goods-param-tpl",['data'=>null])
    </script>
    <script type="text/html" id="photo-tpl">
        @include("v1.admin_platform.integral.components.photo-tpl",['data'=>null])
    </script>
@endsection
...
@section('script')
    ...
    <script>
        ...
        var uploadAvatar = upload.render({
            elem: '#b-upload-image'
            ,url: '{{url($url_prefix.'admin/platform/integral/goods/api/upload_image')}}'
        ...
        var uploadPhotoVideo = upload.render({
            ...
            ,url: '{{url($url_prefix.'admin/platform/integral/goods/api/upload_video')}}'
            ,data: {'_token':'{{csrf_token()}}'}
            ,size: 50000//KB
            ,accept:'video'
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/platform/integral/goods/api')}}";
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/admin/platform/integral/goods/api')}}/{{$data->id}}";
            submitMethod = "PUT";
        @endif
