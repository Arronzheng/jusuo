...
@section('script')
    ...
    <script>
        ...
        form.render();
        let brand_id = '{{request()->input('b',0)}}';
        let base_api = '{{url('/admin/platform/integral/brand_account/api/recharge_list')}}?b='+brand_id;
        let table_api = '{{url('/admin/platform/integral/brand_account/api/recharge_list')}}?b='+brand_id;
        //转换静态表格
    ...
    <script>
        ...
        function export_table(){
            ...
            $('#filter-form').attr('action',"{{url('/admin/platform/integral/brand_account/api/recharge_list')}}");
            $('#filter-form').submit();
        }
