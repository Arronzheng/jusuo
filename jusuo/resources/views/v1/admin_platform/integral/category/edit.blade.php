    ...
    <div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 20px 30px 0 0;">
        <form>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="name" value="{{$data->name or ''}}" placeholder="请输入分类名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <div class="layui-upload-drag" id="b-upload-image">
                        ...
                        <input type="hidden" name="photo" value="{{$data->photo or ''}}"/>
...
@section('script')
    ...
    <script>
        ...
        var uploadAvatar = upload.render({
            elem: '#b-upload-image'
            ,url: '{{url($url_prefix.'admin/platform/integral/category/api/upload_image')}}'
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/platform/integral/category/api')}}";
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/admin/platform/integral/category/api')}}/{{$data->id}}";
            submitMethod = "PUT";
        @endif
