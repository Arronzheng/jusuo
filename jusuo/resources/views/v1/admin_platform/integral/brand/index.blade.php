...
@section('content')
    <div class="layui-card layadmin-header">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite>品牌管理</cite></a><span lay-separator="">/</span>
            <a><cite>品牌列表</cite></a>
        </div>
    </div>
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        {{--删除--}}
        {{--<a href="javascript:;" title="隐藏" onclick="destroyData('@{{d.id}}')" class="layui-btn-danger layui-btn  layui-btn-xs" lay-event="edit">
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/integral/brand/api')}}';
        let table_api = '{{url('/admin/platform/integral/brand/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'photo',width:100, title: '品牌logo',templet: function(d){
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/platform/integral/brand/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/platform/integral/brand')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
        ...
        function destroyData(id){
            let apiUrl = '{{url('/admin/platform/integral/brand/api')}}/'+id;
