        ...
        <form>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="name" value="{{$data->name or ''}}" placeholder="请输入品牌名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span class="required">*</span> 品牌LOGO</label>
                <div class="layui-input-inline">
...
@section('script')
    ...
    <script>
        ...
        var uploadAvatar = upload.render({
            elem: '#b-upload-image'
            ,url: '{{url($url_prefix.'admin/platform/integral/brand/api/upload_image')}}'
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/platform/integral/brand/api')}}";
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/admin/platform/integral/brand/api')}}/{{$data->id}}";
            submitMethod = "PUT";
        @endif
