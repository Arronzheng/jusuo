...
@section('content')
    <div class="layui-tab layui-tab-brief" >
        <ul class="layui-tab-title">
            <li onclick="location.href='{{url($url_prefix.'admin/platform/security_center/bind_wechat')}}'" >绑定微信</li>
            {{--<li onclick="location.href='{{url($url_prefix.'admin/platform/security_center/secret_question')}}'">密保问题</li>--}}
            <li onclick="location.href='{{url($url_prefix.'admin/platform/security_center/modify_pwd')}}'" class="layui-this">修改密码</li>
            {{--<li onclick="location.href='{{url($url_prefix.'admin/platform/security_center/reset_pwd')}}'">重置密码</li>--}}
        </ul>
...
@section('script')
    <script>
        ...
        form.on('submit(submitFormBtn)', function(form_info){
            ...
            ajax_post('{{url($url_prefix.'admin/platform/security_center/api/modify_pwd')}}',
                form_field,
                function(result){
                    if(result.status){
                        layer.msg('修改成功！')
