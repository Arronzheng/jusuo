...
@section('content')
    ...
    <div class="layui-fluid">
        ...
        @can('platform_setting.product.product_category_create')
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/param_config/product/product_category/api')}}';
        let table_api = '{{url('/admin/platform/param_config/product/product_category/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'brand_code', title: '品牌大写字母编码'}
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/platform/param_config/product/product_category/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/platform/param_config/product/product_category')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
