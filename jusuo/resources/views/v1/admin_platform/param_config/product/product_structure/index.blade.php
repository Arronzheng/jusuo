...
@section('content')
    ...
    <div class="layui-fluid">
        ...
        @can('platform_setting.product.product_structure_create')
    ...
    <script type="text/html" id="tableToolbarTpl">
        @can('platform_setting.product.product_structure_edit')
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/param_config/product/product_structure/api')}}';
        let table_api = '{{url('/admin/platform/param_config/product/product_structure/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/platform/param_config/product/product_structure/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/platform/param_config/product/product_structure')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
