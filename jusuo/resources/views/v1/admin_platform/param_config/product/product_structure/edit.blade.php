...
@section('script')
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/platform/param_config/product/product_structure/api')}}";
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/admin/platform/param_config/product/product_structure/api')}}/{{$data->id}}";
            submitMethod = "PUT";
        @endif
