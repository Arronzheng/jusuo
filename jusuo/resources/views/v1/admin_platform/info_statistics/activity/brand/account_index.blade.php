...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/info_statistics/activity/brand/api')}}';
        let table_api = '{{url('/admin/platform/info_statistics/activity/brand/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'count_album_increase_day_7',width:130,sort: true, title: '新增方案数'}
                ,{field: 'count_product_increase_day_7',width:160,sort: true, title: '新增上传产品数'}
                ,{field: 'count_dealer_lv1_increase_day_7',width:160, sort: true,title: '新增一级销售商数'}
                ,{field: 'count_dealer_lv2_increase_day_7',width:160, sort: true,title: '新增二级销售商数'}
                ,{field: 'count_designer_increase_day_7',width:160,sort: true, title: '新开通直属设计师数 '}
            ]]
        });
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/platform/info_statistics/activity/brand')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
