...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/platform/info_statistics/product/ceramic/api/get_brands') !!}',
                        cols: [[
                            { type: 'radio' },
        ...
        let base_api = '{{url('/admin/platform/info_statistics/product/ceramic/api')}}';
        let table_api = '{{url('/admin/platform/info_statistics/product/ceramic/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'brand_name', width:160,title: '所属品牌'}
        ...
        function export_table(){
            ...
            $('#filter-form').attr('action',"{{url('/admin/platform/info_statistics/product/ceramic/api')}}");
            $('#filter-form').submit();
            window.open();
        }
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/platform/info_statistics/product/ceramic')}}/'+id;
            layer.open({
                type: 2,
                title:'产品详情',
                area:['700px', '500px'],
        ...
        function editData(type,id){
            let page = '{{url('/admin/platform/info_statistics/product/ceramic/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/platform/info_statistics/product/ceramic')}}/'+id+"/edit";
            }
