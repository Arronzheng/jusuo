        ...
        <div id="filterContainer" class="layui-form c-table-filter-container fold" lay-filter="app-content-list">
            ...
            <form action="" method="get">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline filter-block">
                        <label class="layui-form-label">所属组织类型：</label>
                        <div class="layui-input-inline" style="padding-right: 14px">
                            <select name="org" lay-verify="" lay-filter="organizationType">
                                <option value="">全部</option>
                                <option value="0">自由</option>
                                <option value="1">品牌</option>
                                <option value="2">销售商</option>
                                <option value="3">装饰公司</option>
                    ...
                    <div class="layui-inline filter-block">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" autocomplete="off" id="no-organization-select" class="organization-select layui-input" readonly placeholder="请选择所属组织类型">
                            <input type="text" style="display:none" autocomplete="off" id="brand-select" class="organization-select layui-input" value="" readonly placeholder="点击搜索并选择">
                            <input type="text" style="display:none" autocomplete="off" id="seller-select" class="organization-select layui-input"  value="" readonly placeholder="点击搜索并选择" >
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/platform/info_statistics/account/designer/api/get_brands') !!}',
                        cols: [[
                            { type: 'radio' },
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/platform/info_statistics/account/designer/api/get_sellers') !!}',
                        cols: [[
                            { type: 'radio' },
                            { field: 'name', title: '组织名称' },
                            { field: 'organization_account', title: '组织账号' },
        ...
        let base_api = '{{url('/admin/platform/info_statistics/account/designer/api')}}';
        let table_api = '{{url('/admin/platform/info_statistics/account/designer/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        //当前条件下重新加载table
        function reloadTable(sortObj,clearPage){
        ...
        function openDetail(id){
            let page = '{{url('/admin/platform/info_statistics/account/designer')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
