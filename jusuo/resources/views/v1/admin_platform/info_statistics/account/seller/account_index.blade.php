...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/platform/info_statistics/account/seller/api/get_brands') !!}',
                        cols: [[
                            { type: 'radio' },
        ...
        let base_api = '{{url('/admin/platform/info_statistics/account/seller/api')}}';
        let table_api = '{{url('/admin/platform/info_statistics/account/seller/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/platform/info_statistics/account/seller')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
