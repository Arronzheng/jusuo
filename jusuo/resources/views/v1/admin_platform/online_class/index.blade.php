...
@section('content')
    <div class="layui-card layadmin-header">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            <a><cite>在线课堂</cite></a><span lay-separator="">/</span>
            <a><cite>品牌账号列表</cite></a>
    ...
    <script type="text/html" id="tableToolbarTpl">
        @can('online_class.brand_modify_pwd')
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/online_class/api')}}';
        let table_api = '{{url('/admin/platform/online_class/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/platform/online_class/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/platform/online_class')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
