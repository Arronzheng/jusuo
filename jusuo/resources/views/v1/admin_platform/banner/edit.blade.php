...
@section('script')
    ...
    <script>
        ...
        var uploadAvatar = upload.render({
            elem: '#b-upload-image'
            ,url: '{{url($url_prefix.'admin/platform/banner/api/upload_image')}}'
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/platform/banner/api')}}";
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/admin/platform/banner/api')}}/{{$data->id}}";
            submitMethod = "PUT";
        @endif
