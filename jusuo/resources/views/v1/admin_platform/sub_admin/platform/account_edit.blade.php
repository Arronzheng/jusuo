...
@section('content')
    <div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 20px 30px 0 0;">
        <form>
            ...
            @if(!isset($data) || (!$data->is_super_admin && auth()->guard('platform')->user()->id!=$data->id) )
            <div class="layui-form-item">
...
@section('script')
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/platform/privilege/api/ajax_parent_privilege') !!}',
                        cols: [[
                            { type: 'radio' },
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/platform/sub_admin/api/account')}}";
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/admin/platform/sub_admin/api/account')}}/{{$data->id}}";
            submitMethod = "PUT";
        @endif
