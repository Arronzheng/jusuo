...
@section('content')
    <div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 20px 30px 200px 0;">
        <form>
            ...
            @if($loginAdmin->id==$data->id)
            <div class="layui-form-item">
                <label class="layui-form-label">旧密码</label>
                <div class="layui-input-inline">
                    <input type="password" name="old_password" value="" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            @endif
...
@section('script')
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/platform/sub_admin/api/account')}}/{{$data->id}}/modify_pwd";
