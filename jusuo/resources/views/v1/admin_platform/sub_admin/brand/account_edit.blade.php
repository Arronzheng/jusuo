        ...
        <form>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="brand_name" value="" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">经营品类</label>
                <div class="layui-input-inline">
                    <select name="product_category_id" lay-filter="aihao">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="login_username" value="" lay-verify="required" autocomplete="off" class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="login_mobile" value="" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="link_man" value="" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
