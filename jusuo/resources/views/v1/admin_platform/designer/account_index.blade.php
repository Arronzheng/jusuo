...
@section('content')
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('account_manage.account_index.free_designer_detail')
        <a onclick="openDetail('@{{d.id}}')" title="查看详情" href="javascript:;"  class="layui-btn-primary layui-btn  layui-btn-xs">
            <i class="layui-icon layui-icon-list"></i>
        </a>
        @endcan

        @can('account_manage.account_index.free_designer_switch')
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/designer/api/account')}}';
        let table_api = '{{url('/admin/platform/designer/api/account')}}?type={{request()->input("type")}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'designer_account',width:100, title: '账号'}
                ...
                ,{field: 'operation',fixed: 'right', title: '操作' , width:170 ,templet:'#tableToolbarTpl'}
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/platform/designer/account')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
