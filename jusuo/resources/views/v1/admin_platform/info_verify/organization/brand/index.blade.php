...
@section('content')
    <div class="layui-card layadmin-header">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite>组织资料</cite></a><span lay-separator="">/</span>
            <a><cite>品牌</cite></a>
        </div>
    </div>
...
@section('body')
    <script type="text/html" id="tableToolbarTpl">
        @can('account_manage.info_verify.org_info.brand_detail')
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/info_verify/organization/api/brand')}}';
        let table_api = '{{url('/admin/platform/info_verify/organization/api/brand')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'brand_name', title: '品牌名称',width:160}
                ,{field: 'name', title: '公司名称',width:160}
                ,{field: 'login_account', title: '账号',}
                ,{field: 'code_license', title: '统一社会信用代码',width:170}
                ,{field: 'legal_person_name', title: '法人代表姓名',}
                ,{field: 'code_idcard', title: '身份证号',width:170}
                ,{field: 'approve_text', title: '审核结果',}
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/platform/info_verify/organization/brand')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
