...
@section('body')
    <script type="text/html" id="tableToolbarTpl">
        @can('account_manage.info_verify.designer_basic_info.free_designer_detail')
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/info_verify/designer_basic/api')}}';
        let table_api = '{{url('/admin/platform/info_verify/designer_basic/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/platform/info_verify/designer_basic')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
