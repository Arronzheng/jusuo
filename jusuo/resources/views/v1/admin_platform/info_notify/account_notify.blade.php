...
@section('content')
    <div class="layui-card layadmin-header">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            <a><cite>信息通知</cite></a><span lay-separator="">/</span>
            <a><cite>账号通知</cite></a>
        </div>
    </div>
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('info_notify.account_notify')
        @{{#     if( !d.is_read ){       }}
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/info_notify/api/account_notify')}}';
        let table_api = '{{url('/admin/platform/info_notify/api/account_notify')}}?type={{request()->input("type")}}';
        //转换静态表格
