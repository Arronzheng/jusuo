...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/privilege_seller/api')}}';
        let table_api = '{{url('/admin/platform/privilege_seller/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/platform/privilege_seller/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/platform/privilege_seller')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
