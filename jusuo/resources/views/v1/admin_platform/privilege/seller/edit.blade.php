...
@section('script')
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/platform/privilege_seller/api/ajax_parent_privilege') !!}',
                        cols: [[
                            { type: 'radio' },
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/platform/privilege_seller/api')}}";
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/admin/platform/privilege_seller/api')}}/{{$data->id}}";
            submitMethod = "PUT";
        @endif
