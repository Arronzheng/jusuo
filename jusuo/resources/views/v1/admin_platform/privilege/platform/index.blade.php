...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/platform/privilege_platform/api')}}';
        let table_api = '{{url('/admin/platform/privilege_platform/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'shown', title: '是否启用' ,templet:'#shownTpl'}
                /*,{field: 'is_super_admin', title: '是否超级管理员',templet:'#isSuperAdminTpl'}*/
                ,{field: 'url', title: '跳转路径'}
                ,{field: 'is_menu', title: '菜单显示',templet:'#isMenuTpl'}
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/platform/privilege_platform/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/platform/privilege_platform')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
