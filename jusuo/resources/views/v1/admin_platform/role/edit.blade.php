        ...
        <form>
            ...
            {{--<div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="is_super_admin" value="1" title="是" @if(isset($data) && $data->is_super_admin==\App\Models\RolePlatform::IS_SUPER_ADMIN_YES) checked @endif>
                    <input type="radio" name="is_super_admin" value="0" title="否" @if(isset($data) && $data->is_super_admin==\App\Models\RolePlatform::IS_SUPER_ADMIN_NO) checked @endif>
                </div>
            </div>--}}
...
@section('script')
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/platform/role/api')}}";
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/admin/platform/role/api')}}/{{$data->id}}";
            submitMethod = "PUT";
        @endif
    ...
    @include('v1.admin.components.role_edit.select_privileges_script',
     ...
     'api_url'=>url($url_prefix.'admin/platform/role/api/get_role_privilege_options')])
    @else
        @include('v1.admin.components.role_edit.select_privileges_script',
