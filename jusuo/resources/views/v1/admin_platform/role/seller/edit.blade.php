...
@section('script')
    ...
    <script>
        ...
        let submitAction = "{{url('/admin/platform/role/seller/api')}}";
        let submitMethod = "";
        @if(isset($data))
            submitAction = "{{url('/admin/platform/role/seller/api')}}/{{$data->id}}";
            submitMethod = "PUT";
        @endif
    ...
    @include('v1.admin.components.role_edit.select_privileges_script',
     ...
     'api_url'=>url($url_prefix.'admin/platform/role/seller/api/get_role_privilege_options')])
    @else
        @include('v1.admin.components.role_edit.select_privileges_script',
