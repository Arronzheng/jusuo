                    ...
                    <div class="layui-inline filter-block">
                        ...
                        <div class="layui-input-inline" style="padding-right: 14px">
                            <select name="is_super_admin" lay-verify="">
                                ...
                                @foreach(\App\Models\RolePlatform::isSuperAdminGroup() as $key=>$item)
...
@section('script')
    ...
    <script>
        ...
        form.render();
        let base_api = '{{url('/admin/platform/role/api')}}';
        let table_api = '{{url('/admin/platform/role/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/platform/role/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/platform/role')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
