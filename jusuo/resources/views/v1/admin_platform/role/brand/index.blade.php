...
@section('script')
    ...
    <script>
        ...
        form.render();
        let base_api = '{{url('/admin/platform/role/brand/api')}}';
        let table_api = '{{url('/admin/platform/role/brand/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/platform/role/brand/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/platform/role/brand')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
