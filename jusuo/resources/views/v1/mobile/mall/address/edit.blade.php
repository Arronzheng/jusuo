...
@section('content')
    <style>
        .layui-form-label{width:60px;!important;padding:9px 0 9px 0;}
                ...
                <form class="layui-form" action="" lay-filter="component-form-group">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="width:100%!important;;margin-left:0!important;;">
                    ...
                    <div class="layui-form-item submit-container">
                        <div class="layui-input-block">
                            ...
                            @endif
                            <button class="layui-btn layui-btn-custom-blue" style="background-color: rgb(255,136,0);" id="submitBtn" lay-submit lay-filter="submitFormBtn">立即提交</button>
...
@section('script')
    ...
    <script>
        ...
        let submitAction = "{{url('/mobile/mall/api/address')}}";
        let submitMethod = "";
        @if(isset($data))
                submitAction = "{{url('/mobile/mall/api/address')}}/{{$data->id}}";
        submitMethod = "PUT";
        @endif
