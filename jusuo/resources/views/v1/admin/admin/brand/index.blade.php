...
@section('content')
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        <a onclick="editData('edit','@{{d.id}}')" href="javascript:;"  class="layui-btn-custom-blue layui-btn  layui-btn-xs" lay-event="edit">
            <i class="layui-icon layui-icon-edit"></i>配额管理
        </a>
        <a onclick="editData('edit','@{{d.id}}')" href="javascript:;"  class="layui-btn-custom-blue layui-btn  layui-btn-xs" lay-event="edit">
    ...
    <script>
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'brand', title: '品牌名称', sort: true}
                ,{field: 'product_category', title: '经营产品', sort: true}
                ,{field: 'contact_name', title: '联系人'}
                ,{field: 'contact_telephone', title: '联系电话'}
                ,{field: 'product_count', title: '产品数'}
                ,{field: 'designer_count_text', title: '设计师账号数'}
                ,{field: 'seller_count_text', title: '销售商账号数'}
                ,{field: 'status_text', title: '状态'}
                ,{field: 'cert_text', title: '认证状态'}
                ,{field: 'created_at', title: '创建时间' , sort: true}
                ,{field: 'expired_at', title: '有效期限' , sort: true}
            ]]
        });
