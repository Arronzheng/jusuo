...
@section('content')
    ...
    @can('account_manage.designer_create')
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('account_manage.designer_detail')
        <a onclick="openDetail('@{{d.id}}')" title="预览详情" href="javascript:;"  class="layui-btn-primary layui-btn  layui-btn-xs">
...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/seller/seller_designer/api/account')}}';
        let table_api = '{{url('/admin/seller/seller_designer/api/account')}}?type={{request()->input("type")}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'designer_type_text',width:100,title: '账号类型'}
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/seller/seller_designer/account/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/seller/seller_designer/account')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
        ...
        function modifyPwd(id){
            let page = '{{url('/admin/seller/seller_designer/account')}}/'+id+"/modify_pwd";
            layer.open({
                type: 2,
                title:'修改密码',
                area:['700px', '500px'],
        ...
        function openDetail(id){
            let page = '{{url('/admin/seller/seller_designer/account')}}/'+id;
            layer.open({
                type: 2,
                title:'预览详情',
                area:['700px', '500px'],
