...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/seller/album/comment/api')}}';
        let table_api = '{{url('/admin/seller/album/comment/api')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                //,{field: 'album_web_id_code', title: '方案编码',width:200}
    ...
    <script>
        ...
        function editData(type,id){
            let page = '{{url('/admin/seller/album/comment/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/seller/album/comment')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
