...
@section('content')
    ...
    <script type="text/html" id="tableToolbarTpl">
        ...
        @can('album_manage.verify.hd_photo_album_detail')
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/seller/album/verify/hd/seller_designer/api/get_brands') !!}',
                        cols: [[
                            { type: 'radio' },
        ...
        let base_api = '{{url('/admin/seller/album/verify/hd/seller_designer/api')}}';
        let table_api = '{{url('/admin/seller/album/verify/hd/seller_designer/api')}}';
        //转换静态表格
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/seller/album/verify/hd/seller_designer')}}/'+id;
            layer.open({
                type: 2,
                title:'方案详情',
                area:['900px', '600px'],
        ...
        function editData(type,id){
            let page = '{{url('/admin/seller/album/verify/hd/seller_designer/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/seller/album/verify/hd/seller_designer')}}/'+id+"/edit";
            }
            layer.open({
                type: 2,
                title:'编辑信息',
