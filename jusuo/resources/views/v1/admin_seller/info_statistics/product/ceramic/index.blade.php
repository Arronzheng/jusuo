...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            layui.use(['jquery','tableSelect'], function () {
                ...
                tableSelect.render({
                    ...
                    table: {
                        url:'{!! url($url_prefix.'admin/seller/info_statistics/product/ceramic/api/get_sellers') !!}',
                        cols: [[
                            { type: 'radio' },
                            { field: 'name', title: '公司名称' },
                            { field: 'seller_name', title: '品牌名称' },
                        ...
                        for(var i=0;i<select_data.length;i++){
                            ...
                            $('#h-belong-seller').val(privilege_id);
        ...
        let base_api = '{{url('/admin/seller/info_statistics/product/ceramic/api')}}';
        let table_api = '{{url('/admin/seller/info_statistics/product/ceramic/api')}}';
        //转换静态表格
        ...
        function export_table(){
            ...
            $('#filter-form').attr('action',"{{url('/admin/seller/info_statistics/product/ceramic/api')}}");
            $('#filter-form').submit();
            window.open();
        }
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/seller/info_statistics/product/ceramic')}}/'+id;
            layer.open({
                type: 2,
                title:'产品详情',
                area:['700px', '500px'],
        ...
        function editData(type,id){
            let page = '{{url('/admin/seller/info_statistics/product/ceramic/create')}}';
            if(type=='edit'){
                page = '{{url('/admin/seller/info_statistics/product/ceramic')}}/'+id+"/edit";
            }
