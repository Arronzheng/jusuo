                ...
                <form action="" method="get">
                    <div class="layui-card-body" style="padding: 15px;">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-form-mid layui-word-aux">
                                    {{\App\Models\DesignerDetail::designerTypeGroup($verify_content['designer_type'])}}
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-form-mid layui-word-aux">
                                    {{\App\Models\DesignerDetail::genderGroup($verify_content['gender'])}}
                                </div>
                            </div>
                        </div>
                              <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-form-mid layui-word-aux">
                                    {{$verify_content['province']->name or ''}}/{{$verify_content['city']->name or ''}}/{{$verify_content['district']->name or ''}}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item" style="margin-top:20px;">
                            ...
                            <div class="layui-input-inline" style="width: 300px">
                                @if($verify_content['is_approved'] == \App\Models\LogDesignerCertification::IS_APROVE_VERIFYING)
                                    @can('account_manage.info_verify.designer_pass')
                                    <a href="javascript:;" onclick="ajax_pass_member('{{url('admin/seller/info_verify/designer_certification/api/seller/'.$verify_content['id'].'/approval')}}')" class="layui-btn-success layui-btn" lay-event="edit">
                                        <i class="layui-icon layui-icon-ok"></i>通过
                                    </a>
                                    @endcan
                                    @can('account_manage.info_verify.designer_reject')
                                    <a href="javascript:;" onclick="ajax_reject_member('{{url('admin/seller/info_verify/designer_certification/api/seller/'.$verify_content['id'].'/reject')}}')" class="layui-btn-danger layui-btn" lay-event="del">
