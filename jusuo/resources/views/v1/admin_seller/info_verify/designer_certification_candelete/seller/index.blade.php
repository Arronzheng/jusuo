...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/seller/info_verify/designer_certification/api/seller')}}';
        let table_api = '{{url('/admin/seller/info_verify/designer_certification/api/seller')}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'code_idcard', title: '身份证号'}
                ,{field: 'nickname', title: '昵称'}
                ,{field: 'login_mobile', title: '注册手机号'}
                ,{field: 'genderText', title: '性别'}
                ,{field: 'local', title: '所在城市'}
                ,{field: 'designer_type_text', title: '账号类型'}
    ...
    <script>
        ...
        function openDetail(id){
            let page = '{{url('/admin/seller/info_verify/designer_certification/seller')}}/'+id;
            layer.open({
                type: 2,
                title:'查看详情',
                area:['700px', '500px'],
