                    ...
                    <div class="layui-input-block">
                        @if($data->collocations)
                            @foreach($data->collocations as $item)
                                <div class="layui-form-mid layui-word-aux" >
                                    <div class="multiple-show-block" >
                                        <div class="row">应用说明：{{isset($item->pivot)?$item->pivot->note:''}}</div>
                                        <div class="row">产品名称：{{$item->name}}，产品编号：{{$item->code}}</div>
                    ...
                    <div class="layui-input-block">
                        @if($data->spaces)
                            @foreach($data->spaces as $item)
                                <div class="layui-form-mid layui-word-aux" >
                                    <div class="multiple-show-block" >
                                        <div class="row">应用摘要：{{$item->title}}</div>
                                        <div class="row">详细说明文字：{{$item->note}}</div>
