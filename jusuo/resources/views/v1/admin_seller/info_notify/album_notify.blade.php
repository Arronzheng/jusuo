...
@section('script')
    ...
    <script>
        ...
        let base_api = '{{url('/admin/seller/info_notify/api/album_notify')}}';
        let table_api = '{{url('/admin/seller/info_notify/api/album_notify')}}?type={{request()->input("type")}}';
        //转换静态表格
        ...
        let tableInstance = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'is_read_text',width:80, title: '是否已读'}
