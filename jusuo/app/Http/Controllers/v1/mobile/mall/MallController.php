...
namespace App\Http\Controllers\v1\mobile\mall;
...
class MallController extends VersionController{
    ...
    public function index(Request $request){
        ...
        return $this->get_view('v1.mobile.mall.index',compact('keyword'));
    ...
    public function address_create(Request $request){
        ...
        return $this->get_view('v1.mobile.mall.address.edit',compact('provinces'));
    }
    ...
    public function address_edit($id,Request $request){
        ...
        return $this->get_view('v1.mobile.mall.address.edit',compact('provinces','cities','districts','data'));
    }

    public function detail($web_id_code,Request $request)
    {
        return $this->get_view('v1.mobile.mall.detail',compact('web_id_code'));
    }

    public function confirm_order(Request $request)
    {

        return $this->get_view('v1.mobile.mall.sheet');
    }
