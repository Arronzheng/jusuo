...
namespace App\Http\Controllers\v1\site\center\statistic;
...
class StatisticController extends VersionController
{
    private $authService;
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.site.center.statistic.index',compact('__BRAND_SCOPE'));
    }
