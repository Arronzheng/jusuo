...
namespace App\Http\Controllers\v1\admin\role_can_delete;
...
class RoleController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin.role.index',compact('datas'));
    }

    //新增页模板
    public function create()
    {
        return $this->get_view('v1.admin.role.edit');
    }
    ...
    public function edit($id)
    {
        ...
        return $this->get_view('v1.admin.role.edit',compact('data'));
    }
}
