...
namespace App\Http\Controllers\v1\admin\platform\info_verify\designer_certification;
...
class DesignerController extends VersionController
{
    ...
    {
        return $this->get_view('v1.admin_platform.info_verify.designer_certification.index');
    }
    ...
    public function detail($id, Request $request)
    {
        ...
        return $this->get_view('v1.admin_platform.info_verify.designer_certification.detail',compact('verify_content'));
