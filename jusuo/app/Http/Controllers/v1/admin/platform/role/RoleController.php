...
namespace App\Http\Controllers\v1\admin\platform\role;
...
class RoleController extends VersionController
{
    ...
    {
        return $this->get_view('v1.admin_platform.role.index');
    }
    ...
    public function create()
    {
        ...
        return $this->get_view('v1.admin_platform.role.edit');
    }

    //编辑页模板
    public function edit($id)
    {
        $data  = RolePlatform::find($id);
        ...
        return $this->get_view('v1.admin_platform.role.edit',compact(
