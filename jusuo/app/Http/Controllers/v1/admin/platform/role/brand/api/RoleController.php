...
namespace App\Http\Controllers\v1\admin\platform\role\brand\api;
...
class RoleController extends ApiController
{
    ...
    public function index(Request $request)
    {
        ...
        $entry->where('is_super_admin',RoleBrand::IS_SUPER_ADMIN_YES);
    ...
    public function get_role_privilege_options(Request $request)
    {
        ...
        $privilege_options = PrivilegeBrand::where('shown',PrivilegeBrand::SHOWN_YES)->get();
