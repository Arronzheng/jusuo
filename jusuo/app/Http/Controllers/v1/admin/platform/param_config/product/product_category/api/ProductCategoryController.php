...
namespace App\Http\Controllers\v1\admin\platform\param_config\product\product_category\api;
...
class ProductCategoryController extends ApiController
{
    ...
    public function store(Request $request)
    {
        ...
        $exist_name = ProductCategory::where('name',$input_data['name'])
            ->first();
        ...
        try{
            ...
            //新建
            $privilege = new ProductCategory();
            $privilege->name = $input_data['name'];
            $privilege->brand_code = $input_data['brand_code'];
            $privilege->brand_admin_code = $input_data['brand_code'];
            $privilege->seller_code = $input_data['brand_code'];
            $privilege->seller_admin_code = $input_data['brand_code'];
            $privilege->save();
    ...
    public function update(Request $request)
    {
        ...
        $data = ProductCategory::find($input_data['id']);
        ...
        try{
            ...
            $data->brand_code = $input_data['brand_code'];
            $data->brand_admin_code = $input_data['brand_code'];
            $data->seller_code = $input_data['brand_code'];
            $data->seller_admin_code = $input_data['brand_code'];
            $data->save();
