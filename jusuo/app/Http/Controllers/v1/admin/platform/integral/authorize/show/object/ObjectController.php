...
namespace App\Http\Controllers\v1\admin\platform\integral\authorize\show\object;
...
class ObjectController extends VersionController
{
    ...
    {
        return $this->get_view('v1.admin_platform.integral.authorize.show.object.index');
    }
