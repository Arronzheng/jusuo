...
namespace App\Http\Controllers\v1\admin\platform\integral\goods;
...
class IntegralGoodsController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin_platform.integral.goods.index',compact('brands','categories'));
    }
    ...
    public function create()
    {
        ...
        return $this->get_view('v1.admin_platform.integral.goods.edit',compact('brands','categories'));
    }
    ...
    public function edit($id)
    {
        ...
        return $this->get_view('v1.admin_platform.integral.goods.edit',compact('data','brands','categories'));
    }
}
