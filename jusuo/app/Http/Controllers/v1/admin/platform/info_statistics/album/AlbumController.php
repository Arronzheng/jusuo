...
namespace App\Http\Controllers\v1\admin\platform\info_statistics\album;
...
class AlbumController extends VersionController
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        return $this->get_view('v1.admin_platform.info_statistics.album.index',compact('vdata'));
    }
