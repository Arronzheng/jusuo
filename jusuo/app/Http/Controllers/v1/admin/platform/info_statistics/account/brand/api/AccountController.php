...
namespace App\Http\Controllers\v1\admin\platform\info_statistics\account\brand\api;
    ...
    public function account_index(Request $request)
    {
        ...
        $entry->join('organization_brands as b','ab.brand_id','=','b.id')
            ...
            ->select([
                ...
                'stat.count_product','stat.count_album','stat.count_designer','stat.count_designer_lv1',
                'stat.count_designer_lv2','stat.count_dealer_lv1','stat.count_dealer_lv2',
        ...
        $datas->transform(function($v){
            ...
            $v->changeStatusApiUrl = url('admin/platform/info_statistics/account/brand/api/'.$v->brand_id.'/top_status');
            return $v;
        });
