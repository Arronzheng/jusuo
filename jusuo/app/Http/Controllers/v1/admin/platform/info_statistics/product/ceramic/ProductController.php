...
namespace App\Http\Controllers\v1\admin\platform\info_statistics\product\ceramic;
...
class ProductController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin_platform.info_statistics.product.ceramic.index',compact('vdata'));
    }
