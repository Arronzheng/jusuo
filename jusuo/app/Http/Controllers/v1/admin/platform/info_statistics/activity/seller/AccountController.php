...
namespace App\Http\Controllers\v1\admin\platform\info_statistics\activity\seller;
...
class AccountController extends VersionController
{
    ...
    public function account_index(\Illuminate\Http\Request $request)
    {
        ...
        return $this->get_view('v1.admin_platform.info_statistics.activity.seller.account_index',compact('vdata'));
    }
