...
namespace App\Http\Controllers\v1\admin\platform\album\verify\hd\brand_apply_show;
...
class AlbumController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin_platform.album.verify.hd.brand_apply_show.index',
            compact('vdata'
            ));
    }
    ...
    public function detail($id)
    {
        ...
        return $this->get_view('v1.admin_platform.album.verify.hd.brand_apply_show.detail',compact(
            'data'
        ));
