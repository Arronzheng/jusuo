...
namespace App\Http\Controllers\v1\admin\platform\album\index\hd\free_designer;
...
class AlbumController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin_platform.album.index.hd.free_designer.index',
            compact('vdata'
            ));
    }
    ...
    public function detail($id)
    {
        ...
        return $this->get_view('v1.admin_platform.album.index.hd.free_designer.detail',compact(
            'data'
        ));
