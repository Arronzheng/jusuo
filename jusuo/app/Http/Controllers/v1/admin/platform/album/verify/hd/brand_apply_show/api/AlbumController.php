...
namespace App\Http\Controllers\v1\admin\platform\album\verify\hd\brand_apply_show\api;
...
class AlbumController extends ApiController
{
    ...
    public function index(Request $request)
    {
        ...
        $entry = Album::query()
            ...
            ->where('status_platform',Album::STATUS_PLATFORM_VERIFYING); //必须是正在申请品牌展示的
    ...
    public function verify_approval($id)
    {
        ...
        try{
            ...
            //更新状态
            $data->status_platform = Album::STATUS_PLATFORM_ON;
            $data->save();
