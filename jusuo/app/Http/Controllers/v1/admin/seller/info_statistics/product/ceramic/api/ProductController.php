...
namespace App\Http\Controllers\v1\admin\seller\info_statistics\product\ceramic\api;
...
class ProductController extends ApiController
{
    ...
    public function index(Request $request)
    {
        ...
        $entry->select(['id','type','parent_id','name','code','sys_code',
            'series_id','spec_id','count_visit','count_fav','visible','point_focus',
            'created_at','status','top_status_dealer'
        ]);
        ...
        $entry->groupBy('product_ceramics.id');
        ...
        $datas->transform(function($v){
            ...
            $v->changeStatusApiUrl = url('admin/seller/info_statistics/product/ceramic/api/'.$v->id.'/top_status');
    ...
    public function change_status($id, Request $request)
    {
        ...
        try{
            ...
            //更新状态
            if($data->top_status_dealer==ProductCeramic::TOP_PLATFORM_OFF){
                $data->top_status_dealer = ProductCeramic::TOP_PLATFORM_ON;
            }else{
                $data->top_status_dealer = ProductCeramic::TOP_PLATFORM_OFF;
            }
