...
namespace App\Http\Controllers\v1\admin\seller\integral\account;
...
class IntegralAccountController extends VersionController
{
    private $authService;
    ...
    {
        return $this->get_view('v1.admin_seller.integral.account.index');
    }
