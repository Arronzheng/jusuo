...
namespace App\Http\Controllers\v1\admin\seller\album\index\hd\seller_designer;
...
class AlbumController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin_seller.album.index.hd.seller_designer.index',
            compact('vdata'
            ));
    }
    ...
    public function preview_album_detail($web_id_code)
    {
        ...
        $preview_seller_id = $seller->id;
        session()->put('preview_seller_id',$preview_seller_id);
    ...
    public function detail($id)
    {
        ...
        return $this->get_view('v1.admin_seller.album.index.hd.seller_designer.detail',compact(
            'data'
        ));
