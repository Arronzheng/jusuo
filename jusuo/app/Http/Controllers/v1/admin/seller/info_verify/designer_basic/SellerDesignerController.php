...
namespace App\Http\Controllers\v1\admin\seller\info_verify\designer_basic;
...
class SellerDesignerController extends VersionController
{
    ...
    public function account_index(\Illuminate\Http\Request $request)
    {
        ...
        return $this->get_view('v1.admin_seller.info_verify.designer_basic.seller.index');
    }
    ...
    public function detail($id, Request $request)
    {
        ...
        return $this->get_view('v1.admin_seller.info_verify.designer_basic.seller.detail',compact('verify_content','member'));
