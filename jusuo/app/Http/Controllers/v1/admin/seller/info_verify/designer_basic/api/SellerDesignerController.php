...
namespace App\Http\Controllers\v1\admin\seller\info_verify\designer_basic\api;
...
class SellerDesignerController extends ApiController
{
    ...
    public function approve_designer($log, $verify_content)
    {
        ...
        $result = $this->basicInfoService->approve_basic_info($user->dealer->id,Designer::ORGANIZATION_TYPE_SELLER,$user->id,$log,$verify_content);
        if($result['status']==1){
