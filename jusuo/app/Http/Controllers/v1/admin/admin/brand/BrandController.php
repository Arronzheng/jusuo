...
namespace App\Http\Controllers\v1\admin\admin\brand;
...
class BrandController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin.admin.brand.index',compact('datas'));
    }

    //新增页模板
    public function create()
    {
        return $this->get_view('v1.admin.admin.brand.edit');
    }
    ...
    public function edit($id)
    {
        ...
        return $this->get_view('v1.admin.admin.brand.edit',compact('data'));
    }
}
