...
namespace App\Http\Controllers\v1\admin\brand\album\index\hd\brand_designer\api;
...
class AlbumController extends ApiController
{
    ...
    public function index(Request $request)
    {
        ...
        $datas->transform(function($v){
            ...
            $v->status_brand_text = Album::statusBrandGroup($v->status_brand);
            $v->changeStatusApiUrl = url('admin/brand/album/index/hd/brand_designer/api/'.$v->id.'/status');
            //平台站状态
