...
namespace App\Http\Controllers\v1\admin\brand\album\index\common;
...
class AlbumController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin_brand.album.index.common.index',
            compact('vdata'
            ));
    }
    ...
    public function detail($id)
    {
        ...
        return $this->get_view('v1.admin_brand.album.index.common.detail',compact(
            'data'
        ));
