...
namespace App\Http\Controllers\v1\admin\brand\album\index\hd\brand_designer;
...
class AlbumController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin_brand.album.index.hd.brand_designer.index',
            compact('vdata'
            ));
    }
    ...
    public function detail($id)
    {
        ...
        return $this->get_view('v1.admin_brand.album.index.hd.brand_designer.detail',compact(
            'data'
        ));
