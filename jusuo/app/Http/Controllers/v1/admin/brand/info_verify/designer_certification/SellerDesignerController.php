...
class SellerDesignerController extends VersionController
{
    ...
    {
        return $this->get_view('v1.admin_brand.info_verify.designer_certification.seller.index');
    }
    ...
    public function detail($id, Request $request)
    {
        ...
        $sellerIds = OrganizationDealer::where('p_brand_id',$brand->id)
        ...
        return $this->get_view('v1.admin_brand.info_verify.designer_certification.seller.detail',compact('verify_content'));
