...
namespace App\Http\Controllers\v1\admin\brand\info_verify\designer_basic;
...
class BrandDesignerController extends VersionController
{
    ...
    public function account_index(\Illuminate\Http\Request $request)
    {
        ...
        return $this->get_view('v1.admin_brand.info_verify.designer_basic.brand.index');
    }
    ...
    public function detail($id, Request $request)
    {
        ...
        return $this->get_view('v1.admin_brand.info_verify.designer_basic.brand.detail',compact('verify_content','member'));
