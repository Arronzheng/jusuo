...
namespace App\Http\Controllers\v1\admin\brand\role;
...
class RoleController extends VersionController
{
    ...
    {
        return $this->get_view('v1.admin_brand.role.index');
    }
    ...
    public function create()
    {
        ...
        return $this->get_view('v1.admin_brand.role.edit');
    }
    ...
    public function edit($id)
    {
        ...
        return $this->get_view('v1.admin_brand.role.edit',compact(
