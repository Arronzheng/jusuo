...
namespace App\Http\Controllers\v1\admin\brand\info_statistics\account\designer;
...
class AccountController extends VersionController
{
    ...
    public function account_index(\Illuminate\Http\Request $request)
    {
        ...
        return $this->get_view('v1.admin_brand.info_statistics.account.designer.account_index',compact('vdata'));
    }
    ...
    public function account_detail($id)
    {
        ...
        return $this->get_view('v1.admin_brand.info_statistics.account.designer.account_detail',compact(
