...
class BrandDesignerController extends VersionController
{
    ...
    {
        return $this->get_view('v1.admin_brand.designer.brand.account_index');
    }
    ...
    public function account_create(Request $request)
    {
        ...
        return $this->get_view('v1.admin_brand.designer.brand.account_edit');
    ...
    public function modify_pwd($id)
    {
        ...
        return $this->get_view('v1.admin_brand.designer.brand.account_modify_pwd',compact(
            'data'
        ));
    ...
    public function modify_level($id)
    {
        ...
        return $this->get_view('v1.admin_brand.designer.brand.account_modify_level',compact(
            'data','detail'
        ));
    ...
    public function account_detail($id)
    {
        ...
        return $this->get_view('v1.admin_brand.designer.brand.account_detail',compact(
            'data'
        ));
