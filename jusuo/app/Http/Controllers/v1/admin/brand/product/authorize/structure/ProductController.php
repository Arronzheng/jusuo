...
namespace App\Http\Controllers\v1\admin\brand\product\authorize\structure;
...
class ProductController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin_brand.product.authorize.structure.index',compact('vdata'));
    }
