...
namespace App\Http\Controllers\v1\admin\brand\product\authorize\structure\object;
...
class ObjectController extends VersionController
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        return $this->get_view('v1.admin_brand.product.authorize.structure.object.index',
            compact('provinces','product_structures'));
    }
