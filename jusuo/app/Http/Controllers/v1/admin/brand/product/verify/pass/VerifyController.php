...
namespace App\Http\Controllers\v1\admin\brand\product\verify\pass;
...
class VerifyController extends VersionController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->get_view('v1.admin_brand.product.verify.pass.index',compact('vdata'));
    }
    ...
    public function detail($id)
    {
        ...
        return $this->get_view('v1.admin_brand.product.verify.pass.detail',compact(
            'data'
        ));
    ...
    public function create()
    {
        ...
        return $this->get_view('v1.admin_brand.product.verify.pass.edit',compact('vdata','cf'));
    }
    ...
    public function edit($id)
    {
        ...
        return $this->get_view('v1.admin_brand.product.verify.pass.edit',compact('data'));
    }
}
