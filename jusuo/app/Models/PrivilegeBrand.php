...
class PrivilegeBrand extends SpatiePermission
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable('privilege_brands');
    }
    ...
    {
        return $this->belongsToMany(AdministratorBrand::class, 'administrator_privilege_brands', 'privilege_id', 'administrator_id');
    }
