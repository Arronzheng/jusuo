...
class PrivilegePlatform extends SpatiePermission
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable('privilege_platforms');
    }
    ...
    {
        return $this->belongsToMany(AdministratorPlatform::class, 'administrator_privilege_platforms', 'privilege_id', 'administrator_id');
    }

    public function roles(): BelongsToMany
    {
        return $this->belongsToMany(
            app(RolePlatform::class),
