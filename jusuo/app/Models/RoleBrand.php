...
class RoleBrand extends SpatieRole
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable('role_brands');
    }

    /*----------角色权限专用start----------*/
    public function getPermissionClass()
    {
        return app(PrivilegeBrand::class);
    }

    public function admins()
    {
        return $this->belongsToMany(AdministratorBrand::class, 'administrator_role_brands', 'role_id', 'administrator_id');
    }

    public function permissions(): BelongsToMany
    {
        return $this->belongsToMany(
            app(PrivilegeBrand::class),
            'role_privilege_brands',
            'role_id',
            'privilege_id'
        );
    }
