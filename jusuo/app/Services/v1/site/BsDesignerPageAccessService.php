...
class BsDesignerPageAccessService
{
    /**
     * 调用者：设计师列表面访问
     */
    public static function designerIndex($params,$request)
    {
        $result = [];
        $result['status'] = 1;
        $result['code'] = 0;
     ...
     * 调用者：设计师详情页面访问
     */
    public static function designerDetail($params,$request)
    {
        $result = [];
        $result['status'] = 1;
        $result['code'] = 0;
        ...
        $loginDesigner = $params['loginDesigner'];
        $targetDesignerId = $params['targetDesignerId'];
