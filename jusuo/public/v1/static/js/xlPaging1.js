;(function ($, window, document, undefined) {
    ...
    Paging.prototype =  {
        ...
        createHtml : function(){
			...
			if(canJump){
				content.push("<li class='xl-jumpText xl-disabled'>跳至<input type='number' id='xlJumpNum'>页</li>");
