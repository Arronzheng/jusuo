...
function showLeftTabs(){
    ajax_get('/center/is_realname',function(res){
        if(res.status){
...
function getUserInfo(){
    ...
    $.get('/center/user_info/get',function(res){
        if(res.status == 1){
            ...
            str+="<input id='avatar_url' type='hidden' value=''/>"
...
function getAppInfo(){
    ...
    $.get('/center/designerInfo/get',function(res){
        if(res.status == 1){
            ...
            str2+="<textarea  name='persondecription' class='titleinput1' placeholder='自我介绍，不超过200字' id='self_introduction'></textarea>"
...
function bindChangePhoneSendCode(){
    ...
    $.get('/center/getResetPhoneCode',data,function(res){
        console.log(res);
        if(res.status == 1){
            layer.msg(res.msg);
        }else{
...
$(function(e) {
    ...
    // str+="<div class='pd_image' id='pd_image'>"+"</div>"
    // str+="<div class='change_pdcon'>"
    // str+="<input id='upload-input' style=' width:82px;height:24px; cursor: pointer;position: absolute; top: 0; left: 0;opacity: 0;' type='file' accept='image/gif, image/jpg, image/png' onchange='showImg(this)'/>"
    // str+="<div class='change_pdimage'>"+"更改头像"+"</div>"
    // str+="</div>"
    // str+="</div>"
    // str+="<div class='pddetail'>"+"用户账号"+"</div>"
    // str+="<div class='pdid'>"+persondetail.id+"</div>"
    // str+="<div class='pddetail'>"+"昵称"+"</div>"
    // str+="<input type='text' name='nicheng' class='nc_input' placeholder='请输入昵称' value='"+persondetail.name+"'/>"
    // str+="<div class='pddetail'>"+"性别"+"</div>"
    // str+="<div class='danxuan'>"
    // if(persondetail.sex=="男"){
    //     str+="<input type='radio' name='gender' id='paixu1' checked>"
    //     str+="<label for='paixu1' style='cursor:pointer;'>男</label>"
    //     str+="<input type='radio' name='gender' id='paixu2'>"
    //     str+="<label for='paixu2' style='cursor:pointer;'>女</label>"
    // }else{
    //     str+="<input type='radio' name='gender' id='paixu1'>"
    //     str+="<label for='paixu1' style='cursor:pointer;'>男</label>"
    //     str+="<input type='radio' name='gender' id='paixu2' checked>"
    //     str+="<label for='paixu2' style='cursor:pointer;'>女</label>"
    // }
    // str+="</div>"
    // str+="<div class='pddetail'>"+"实名认证"+"</div>"
    // if(persondetail.identity==2){
    //     str+="<div style='margin-top:10px;height:44px;'>"
    //     str+="<span class='iconfont icon-shimingrenzheng' style='color:#1582FF;font-size:16px;margin-top:2px;'>"+"</span>";
    //     str+="<span class='identext'>"+"已认证"+"</span>"
    //     str+="</div>"
    ...
    //     str+="<div class='idbutton' onclick='personchangenav(1)'>"+"去认证"+"</div>"
    // }
    // str+="<div class='saveperson'>"+"保存"+"</div>"
    // $("#f0content").append(str);
    // $("#pd_image").css({"background-image":"url('"+persondetail.image+"')"});

    // //未实名认证
    // var str1="";
    // str1+="<div class='safelabel'>姓名</div>"
    // if(persondetail.identity==3) {
    //     str1 += "<input type='text' name='name'  class='tc_input' placeholder='请输入您的姓名' value='" + shiming.name + "'/>"
    // }else{
    //     str1+="<input type='text' name='name'  class='tc_input' placeholder='请输入您的姓名'/>"
    // }
    // str1+="<div class='safelabel'>身份证号</div>"
    // if(persondetail.identity==3) {
    //     str1 += "<input type='text' name='id'  class='tc_input' placeholder='请输入您的身份证号' value='" + shiming.id + "'/>"
    // }else{
    //     str1 += "<input type='text' name='id'  class='tc_input' placeholder='请输入您的身份证号'/>"
    // }
    // str1+="<div class='safelabel'>上传身份证</div>"
    // str1+="<div class='idcardimage'>"
    // str1+="<div class='idcard_front'>"
    ...
    // str1+="<div class='id_front'></div>"
    // str1+="<div class='del_fengmian' style='display: none;' onclick='del_idfront()'>删除</div>"
    // str1+="<input id='upload-inputf' style='width:252px;height:156px; cursor: pointer;position: absolute; top: 0; left: 0;opacity: 0;' type='file' accept='image/gif, image/jpg, image/png' onchange='showImgfront(this)'/>"
    // str1+="</div>"
    // str1+="<div class='id_tip'>上传身份证正面图片</div>"
    // str1+="</div>"
    // str1+="<div class='idcard_front' style='margin-left:16px;'>"
    ...
    // str1+="<div class='id_back'></div>"
    // str1+="<div class='del_fengmian1' style='display: none;' onclick='del_idback()'>删除</div>"
    // str1+="<input id='upload-input1' style='width:252px;height:156px; cursor: pointer;position: absolute; top: 0; left: 0;opacity: 0;' type='file' accept='image/gif, image/jpg, image/png' onchange='showImgback(this)'/>"
    // str1+="</div>"
    // str1+="<div class='id_tip'>上传身份证背面图片</div>"
    // str1+="</div>"
    // str1+="</div>"
    // str1+="<div class='confirmidentity' onclick='smcommit()'>提交</div>"
    // $("#f1content").append(str1);
    //
    // if(persondetail.identity==3){
    //     if(id_front.length>0){
    //         $(".id_front").hide().removeClass('show')
    //         $("#preview").css({"background-image":"url('"+id_front[0]+"')"});
    //     }
    //     if(id_back.length>0){
    //         $(".id_back").hide().removeClass('show')
    //         $("#preview1").css({"background-image":"url('"+id_back[0]+"')"});
    //     }
    // }
    //
    // //实名认证通过
    // var smname="";
    // var smid="";
    // for(var j=0;j<shiming.name.length;j++){
    //     if(j==0){
    //         smname=smname+shiming.name[0]
    //     }else{
    //         smname=smname+"*"
    //     }
    // }
    // console.log('sdad'+smname)
    // smid=smid+shiming.id[0]+shiming.id[1]+shiming.id[2]+shiming.id[3]+shiming.id[4]+"*********"+shiming.id[12]+shiming.id[13]+shiming.id[14]+shiming.id[15]
    // $('#f1contname').html(smname)
    // $('#f1contid').html(smid)
    ...
    // var str2="";
    // str2+="<div class='f2label'>用户账号</div>"
    // str2+="<div class='f2text'>"+"abc1453224"+"</div>"
    // str2+="<div class='f2label'>出生年月</div>"
    // str2+="<div class='selectdesign'>"
    // str2+="<div class='select-menu' style='width:194px;margin-left:20px;margin-top:10px;'>"
    // str2+="<div class='select-menu-div' style='width:194px;'>"
    // str2+="<input readonly class='select-menu-input' placeholder='年份'/>"
    // str2+="<i class='fa fa-angle-down' style='font-size:22px;color:#B7B7B7;'></i>"
    ...
    // str2+="<i class='fa fa-angle-down' style='font-size:22px;color:#B7B7B7;'></i>"
    // str2+="</div>"
    // str2+="<ul class='select-menu-ul' style='width:194px;height: 200px; overflow:scroll;' id='city'>"
    // str2+="</ul>"
    // str2+="</div>"
    // str2+="<div class='select-menu' style='width:194px;margin-left:10px;margin-top:10px;'>"
    // str2+="<div class='select-menu-div' style='width:194px;'>"
    ...
    // str2+="<div class='f2label'>教育信息</div>"
    // str2+="<div id='education'>"+"</div>"
    // str2+="<div class='addeducate' onclick='addedcation(educatenumber+1)'>"+"添加教育信息"+"</div>"
    // str2+="<div class='f2label'>工作经历</div>"
    // str2+="<div id='experience'>"+"</div>"
    // str2+="<div class='addeducate' onclick='addexperience(worknumber+1)'>"+"添加工作经历"+"</div>"
    // str2+="<div class='f2label'>证书与奖项</div>"
    // str2+="<div id='prize'>"+"</div>"
    // str2+="<div class='addeducate' onclick='addprize(prizenumber+1)'>"+"添加工作经历"+"</div>"
    // str2+="<div class='f2label'>自我介绍</div>"
    // str2+="<textarea  name='persondecription' class='titleinput1' placeholder='自我介绍，不超过200字'></textarea>"
    // str2+="<div class='desigbutton'>"+"提交"+"</div>"
    // $("#f2content").append(str2);
    // //年月日
    // selectMenu(10);
    // selectMenu(11);
    ...
    // $('#day').val("");
    // //改变year调用months和days函数，以下类同
    // $(".select-menu-ul").eq(10).on("click","li",function(){
    //     months("month");
    //     days();
    // })
    // $(".select-menu-ul").eq(11).on("click","li",function(){
    ...
    // selectMenu(14);
    // selectMenu(15);
    // $(".select-menu-ul").eq(13).on("click","li",function(){
    //     showCity();
    // })
    // $(".select-menu-ul").eq(14).on("click","li",function(){
    //     showArea();
    ...
    // $('#bymonth0').val("");
    // //改变year调用months和days函数，以下类同
    // $(".select-menu-ul").eq(16).on("click","li",function(){
    //     months("bymonth0");
    // })
    //
    // //工作经验
...
function morefangan(begin,end){
    ...
    for(var i=begin;i<end;i++){
        ...
        str+="<div class='moreview' id='more_"+i+"' onclick='choosemore("+i+")'>"+"</div>"
        str+="<div class='morechoose' id='morechoose_"+i+"' style='display: none;'>"
        //编辑状态下才能编辑
...
function addexperience(i,data){
    ...
    str+="</div>"
    str+="<textarea  name='styledecription' class='titleinput1' placeholder='工作描述，不超过200字' style='margin-bottom:20px;'></textarea>"
    str+="</div>"
